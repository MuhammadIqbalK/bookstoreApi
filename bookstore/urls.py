...
from .views import (BookListView, BookDetailView, BookCreateView,TransactionListView, TransactionCreateView, TransactionDetailView, 
                    TransactionUpdateView,CustomLoginView, RegisterView, LogoutView, CustomTokenRefreshView, ChangePasswordView, 
...
urlpatterns = [
    ...
    # Membuat Route untuk Api endpoint Transaction
     ...
     path('transactions/<int:pk>/status/',TransactionUpdateView.as_view(), name='api-transaction-status-update'),
